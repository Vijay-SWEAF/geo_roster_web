-- GeoRoster production migration 006.
-- MANUAL EXECUTION ONLY after 001-005 verification and owner approval.
-- Additive document metadata only; encrypted file bytes remain outside the database.
