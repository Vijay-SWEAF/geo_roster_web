-- READ ONLY preparation pack: GeoRoster Prompt 03H group medical insurance status.
-- Execute only through the approved production change process.
-- Additive CREATE TABLE only; no backfill and no existing-row updates.
